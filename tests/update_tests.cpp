...
int main(int argc,char** argv) try {
    ...
    const nlohmann::json manifest{{"schema",1},{"product","sempervirens-windows-x64"},{"channel","stable"},
        ...
        {"outputSha256",new_hash},{"outputSize",fresh.size()},{"packages",nlohmann::json::array({{
            {"kind","full"},{"urls",nlohmann::json::array({"https://github.com/XintingleiTeam/sempervirens/releases/download/v0.1.0.1/SempervirensApp.exe","https://api.update.xintinglei.cn/releases/0.1.0.1/SempervirensApp.exe"})},
    ...
    rejected_manifest["packages"][0]["urls"][1]="https://api.xintinglei.cn/api/sempervirens/update/releases/0.1.0.1/SempervirensApp.exe";
